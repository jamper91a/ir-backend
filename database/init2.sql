...
-- Schema inventarioReal
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `inventarioReal` DEFAULT CHARACTER SET utf8 ;
USE `inventarioReal` ;
...
CREATE TABLE IF NOT EXISTS `inventarioReal`.`inventarios` (
  ...
  `createdAt` DATETIME NULL,
  `updatedAt` DATETIME NULL,
  `inventarios_consolidados_id` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `inventarioReal`.`productos_zonas_has_transferencias`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inventarioReal`.`productos_zonas_has_transferencias` ;

CREATE TABLE IF NOT EXISTS `inventarioReal`.`productos_zonas_has_transferencias` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `productos_zonas_id` INT NOT NULL,
...
START TRANSACTION;
USE `inventarioReal`;
INSERT INTO `inventarioReal`.`users` (`id`, `username`, `password`, `username_rfdi`, `password_rfdi`, `groups_id`, `createdAt`, `updatedAt`) VALUES (1, 'jamper91', '$2a$10$aeX8/2lzP3.t4rsJA.ozZuz5jDaScKuC4S0QRXMWqf.eOOa9WEcqS', ' ', NULL, 1, '2018-08-10 00:00:00', '2018-08-10 00:00:00');
...
-- -----------------------------------------------------
-- Data for table `inventarioReal`.`productos`
-- -----------------------------------------------------
START TRANSACTION;
USE `inventarioReal`;
INSERT INTO `inventarioReal`.`productos` (`id`, `ean`, `plu`, `plu2`, `plu3`, `marca`, `genero`, `color`, `talla`, `categoria`, `descripcion`, `cantidad`, `imagen`, `createdAt`, `precio_costo`, `precio_venta`, `companias_id`, `updatedAt`, `proveedores_id`) VALUES (1, '11111', 'p11111', 'p211111', 'p311111', 'Arturo Calle', 'M', 'Negro', 'S', 'Camisas', 'Camisa hombre', '10', NULL, '2018-08-10', 150000, 160000, 1, '2018-08-10', DEFAULT);
INSERT INTO `inventarioReal`.`productos` (`id`, `ean`, `plu`, `plu2`, `plu3`, `marca`, `genero`, `color`, `talla`, `categoria`, `descripcion`, `cantidad`, `imagen`, `createdAt`, `precio_costo`, `precio_venta`, `companias_id`, `updatedAt`, `proveedores_id`) VALUES (2, '11112', 'p11112', 'p211112', 'p311112', 'Arturo Calle', 'F', 'Rosa', 'S', 'Camisas', 'Camisa mujer', '10', NULL, '2018-08-10', 10000, 16000, 1, '2018-08-10', DEFAULT);
...
START TRANSACTION;
USE `inventarioReal`;
INSERT INTO `inventarioReal`.`salidas` (`id`, `name`, `createdAt`, `updatedAt`) VALUES (DEFAULT, 'Perdida', '2018-08-10 00:00:00', '2018-08-10 00:00:00');
INSERT INTO `inventarioReal`.`salidas` (`id`, `name`, `createdAt`, `updatedAt`) VALUES (DEFAULT, 'Extravio', '2018-08-10 00:00:00', '2018-08-10 00:00:00');
INSERT INTO `inventarioReal`.`salidas` (`id`, `name`, `createdAt`, `updatedAt`) VALUES (DEFAULT, 'Robo', '2018-08-10 00:00:00', '2018-08-10 00:00:00');
INSERT INTO `inventarioReal`.`salidas` (`id`, `name`, `createdAt`, `updatedAt`) VALUES (DEFAULT, 'Retiro', '2018-08-10 00:00:00', '2018-08-10 00:00:00');
